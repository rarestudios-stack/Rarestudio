...
export default function FAQs() {
  ...
  return (
    <div className="w-screen h-auto md:mb-0 font-Kanit">
      <div
        id="faqs"
        className="md:px-16 px-4 py-4 bg-black/30 filter backdrop-blur-sm text-white"
      >
        <Accordion open={open === 1} animate={customAnimation}>
          ...
          <AccordionBody className="text-justify">
            <p className={open == 1 ? "md:pr-4" : "hidden"}>
              Welcome to the Rare Studios New York. A web 3 company designed for
              the next generation of digital entertainment. By combining the
              power of immersive story-driven experiences with digital &
              physical collectibles, we are redefining what it means to build a
              global entertainment brand in the digital age. Here at Rare
              Studios New York, we firmly believe that the true potential of
              web3 can only be unleashed if we allow ourselves to dream big,
              without any constraints holding us back. No boundaries, no
              leaders, just a group of interesting people coming together to
              make some seriously epic shit. We are creating a world, where
              enthusiasts and players alike become the masters of their own
              creations. As a valued member of our exclusive community of
              brands, get ready to enter a one-of-a-kind and unforgettable
              journey with us.
            </p>
          </AccordionBody>
        </Accordion>
        ...
        <Accordion open={open === 3} animate={customAnimation}>
          ...
          <AccordionBody className="flex flex-col md:items-start items-center">
            <div
              className={
                open == 3
                  ? "md:flex items-start justify-start transition duration-300 ease-in-out"
